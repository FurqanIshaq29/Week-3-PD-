...
int main()
{
int num1,num2,num3,num4,num5,num6,num7,num8,num9,num10,num11,num12,num13,num14,num15,a,b,c,out;
...
b = num6*num7*num8*num9*num10;
c = (num11-num12-num13-num14-num15);
out = (a+b)-c;
cout<< "Total Output : " << out ;
return 0;
}
